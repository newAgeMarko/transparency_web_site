...
<head>
	...
	<!-- Language script -->
	<script src='../../js/datepicker-sr.js' type='text/javascript'></script>
...
<body class="c-layout-header-fixed c-layout-header-mobile-fixed c-layout-header-fullscreen c-layout-header-topbar">
	...
	<div id="page">
        ...
        <div class="my_container">	
			<div class="container">
				<p style="height:auto;"><iframe frameborder="0" height="100%" scrolling="yes" src="monthly.php" width="100%"></iframe></p>
			</div>			
		</div>
