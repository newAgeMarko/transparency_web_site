...
<body class="c-layout-header-fixed c-layout-header-mobile-fixed c-layout-header-fullscreen c-layout-header-topbar">
	...
	<div id="page">
        ...
        <div class="my_container">	
			<div class="container">
				<p style="height:7000px"><iframe id="Iframe" frameborder="0" height="100%" scrolling="yes" src="daily.php" width="100%"></iframe></p>
			</div>		
		</div>
	...
	<script src="https://code.highcharts.com/modules/exporting.js"></script>
		...
		<script>
			$(document).ready(function(){
					...
					frames["Iframe"].document.offsetHeight = "1200px";
					// var the_height = document.getElementById('#Iframe').document.body.offsetHeight;
			});	
		</script>	
