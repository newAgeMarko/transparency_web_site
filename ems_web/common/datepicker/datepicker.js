;(function (window, $, undefined) { ;(function () {
    ...
    $.fn.datepicker.language = {
        cir: {
            ...
            daysMin: ['Не','Пн','Ут','Ср','Чт','Пт','Су'],
            months: ['Јануар', 'Фебруар', 'Март', 'Април', 'Мај', 'Јун', 'Јул', 'Август', 'Септебар', 'Октобар', 'Новембар', 'Децембар'],
		...
		lat: {
            ...
            daysMin: ['Ne','Pn','Ut','Sr','Čt','Pt','Su'],
            months: ['Januar', 'Februar', 'Mart', 'April', 'Maj', 'Jun', 'Jul', 'Avgust', 'Septebar', 'Oktobar', 'Novembar', 'Decembar'],
