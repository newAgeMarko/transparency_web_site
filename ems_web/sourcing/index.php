	...
	<table id="results" class="cell-border stripe" style="width:100%">
		<thead>
			<tr>
				...
				<th><?= _NAME ?></th>
				<th><?= _REQUESTED_QUANTITY ?> [MWh]</th>
				<th><?= _AWARD_QUANTITY ?> [MWh]</th>
...
table = $('#results').dataTable({
	...
	"autoWidth": false,
	"lengthMenu": [ 10, 25, 50 ],
    "sAjaxSource": "../../sap_sourcing/getdata_loss.php",
    "aoColumns": [
        { mData: 'BID_DATE', className: 'dt-left', sWidth: '80px', sType: 'date-sr'},
        { mData: 'UNIQUE_DOC_NAME', className: 'dt-left', sWidth: '180px'},
        { mData: 'DISPLAY_NAME', className: 'dt-left' },
        { mData: 'REQUESTED_QUANTITY', className: 'dt-right', sWidth: '120px'},
        { mData: 'AWARD_QUANTITY', className: 'dt-right', sWidth: '120px'},
        { mData: 'BID_PRICE', className: 'dt-right', sWidth: '50px' }
    ]
<?php 
	if ($lng!="eng") {
?>		
