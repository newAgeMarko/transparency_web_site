...
function GetData(d) {
	...
	$.getJSON("get_results.php", { day: d }, function(result) { 
														...
														if(result == null) {
															...
															var line = '<tr><td colspan="6" style="height:1px; margin:0; padding:0; background-color:#016DB6;"></td></tr>';
															tbodyHTML_1 = line;
															tbodyHTML_2 = line;
															tbodyHTML_3 = line;
															tbodyHTML_4 = line;
