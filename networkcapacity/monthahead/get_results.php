<?php
	...
	$data = null;	
	// $sql = "SELECT * FROM resultsm WHERE MONTH(period_od) = $number_month AND YEAR(period_od) = $year";
	$sql = "SELECT * FROM NTCm WHERE MONTH(period_od) = $number_month AND YEAR(period_od) = $year ORDER BY field(granica_smer, 'HURS', 'RORS', 'ALRS', 'BARS', 'BGRS', 'HRRS', 'MERS', 'MKRS', 'RSHU', 'RSRO', 'RSAL', 'RSBA', 'RSBG', 'RSHR', 'RSME', 'RSMK'), period_od";
	$res = $conn->query($sql);
