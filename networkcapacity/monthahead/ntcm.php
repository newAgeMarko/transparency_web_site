...
<body class="c-layout-header-fixed c-layout-header-mobile-fixed c-layout-header-fullscreen c-layout-header-topbar">
	...
	<div id="page">
        ...
        <div class="my_container">
			<div class="container">
 			<!--	<p style="height:2300px;"><iframe id="Iframe" height="100%" frameborder="0" scrolling="yes" src="monthly.php" width="100%"></iframe></p> -->
			<p style="height:auto;"><iframe id="Iframe" height="100%" frameborder="0" scrolling="yes" src="monthly.php" width="100%"></iframe></p>
			</div>			
		</div>
