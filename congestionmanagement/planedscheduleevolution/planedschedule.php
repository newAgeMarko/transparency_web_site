...
<body class="c-layout-header-fixed c-layout-header-mobile-fixed c-layout-header-fullscreen c-layout-header-topbar">
	...
	<div id="page">
        ...
        <div class="my_container">
			<div class="container">
				<h4><?= $_PLANED_SCHEDULE_EVOLUTION_DESC ?></h4>
				<p style="height:auto;"><iframe frameborder="0" height="100%" scrolling="yes" src="ps.php" width="100%" style="margin-top: 70px;"></iframe></p>
			</div>			
		</div>
