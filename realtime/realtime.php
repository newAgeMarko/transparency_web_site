...
var c_granica = ["Мађарска", "Румунија", "Бугарска", "Македонија", "Албанија", "Црна Гора", "Босна и Херцеговина", "Хрватска"]; 
var l_granica = ["Mađarska", "Rumunija", "Bugarska", "Makedonija", "Albanija", "Crna Gora", "Bosna i Hercegovina", "Hrvatska"]; 
var e_granica = ["Hungary", "Romania", "Bulgaria", "Macedonia (FYRM)", "Albania", "Montenegro", "Bosnia and Herzegovina", "Croatia"]; 
...
<div class="mapa">
    ...
    <div class="labela regulacija"> 
			...
			<div class="podatak razmena cw" id="reg_greska_EMS"></div>
