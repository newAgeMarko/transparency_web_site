...
<body class="c-layout-header-fixed c-layout-header-mobile-fixed c-layout-header-fullscreen c-layout-header-topbar">
	...
	<div id="page">
        ...
        <div class="my_container">
			<div class="container">
				<h3><?= $SYSTEM_VERTICAL_LOAD_FORECAST ?></h3>
				<p><?= $DAY_AHEAD ?></p>
				<h3><?= $SYSTEM_VERTICAL_REALISED_LOAD ?></h3>
				<p><?= $REALISED_VERTICAL_LOAD_PER_BIDDING_ZONE ?></p>
				
				<p><iframe frameborder="0" height="100%" scrolling="yes" src="dayload.php" width="100%" style="margin-top: 25px;"></iframe></p>
			</div>            
		</div>
